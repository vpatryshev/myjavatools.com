...
public class XmlWriter extends Writer
{
  ...
  protected Stack<CharSequence> Elements = new Stack<CharSequence>();
   ...
   */
  static public CharSequence xmlEscape(CharSequence s)
  {
   ...
   * @throws java.io.IOException if something went wrong
   */
  public void writeAttribute(CharSequence name, CharSequence value) throws java.io.IOException
  {
    if (!isEmpty(value)) {
   ...
   */
  public String attributeToString(CharSequence name, CharSequence value) {
    return isEmpty(value) ? "" :
           (" " + name + "=\"" + xmlEscape(value) + "\"");

  }

  private static final String[] SPECIAL_ATTRIBUTES = {"id", "name"};
   ...
   */
  public void writeAttributes(Map<String,String> attrs) throws java.io.IOException
  {
    if (attrs != null) {
      for (String special : SPECIAL_ATTRIBUTES) {
        writeAttribute(special, attrs.get(special));
      }
      for(String key : attrs.keySet()) {
        ...
        if (okToWrite) {
          writeAttribute(key, attrs.get(key));
        }
      }
    }
  }
   ...
   * @throws java.io.IOException
   */
  public void openElement(String type,
                          Map<String,String> attrs) throws java.io.IOException
  {
    Elements.push(type);
    write(prefix + "<" + type);
 ...
 */
   ...
   * @throws java.io.IOException
   */
  public void writeElement(CharSequence type, String value) throws java.io.IOException
  {
   ...
   * @throws java.io.IOException
   */
  public void writeElement(String type, String value,
  ...
  protected void writeXmlData(XmlData data)
    ...
    Collection<? extends XmlData> kids = data.getAllKids();
...
//      writeMap((Map)o);
  ...
  protected static final boolean isEmpty(CharSequence cs) {
    return cs == null || cs.length() == 0;
  }

  private static final String SPACE_CHARS = " \r\n\t\f";
  protected static final boolean isAlmostEmpty(CharSequence string) {
    if (isEmpty(string)) return true;

    for (int i = 0; i < string.length(); i++) {
      if (SPACE_CHARS.indexOf(string.charAt(i)) < 0) {
        return false;
      }
    }
    return true;
