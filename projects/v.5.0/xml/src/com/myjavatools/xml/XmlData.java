...
public interface XmlData
{
 ...
 /**
   ...
   */
  public Collection<? extends XmlData> getAllKids();

  /**
   * Gets a Collection&lt;? extends XmlData> of kids of specified type.
   *
   * @param type type of the kids to choose
   * @return all kids that have the specified type
   */
  public Collection<? extends XmlData> getKids(String type);
   ...
   * @return Collection&lt;? extends XmlData> of removed kids
   */
  public Collection<? extends XmlData> removeKids(String type);
   ...
   */
  public boolean castKids(String type, Class<? extends XmlData> clazz);
}
