...
public class TestRss_0_93 extends TestCase {
  private Rss localSampleRss = null;
  private String outputFileName = "sample_rss_093_output.xml";
...
//      assertEquals(message + " - comparing kids:", expected.getAllKids(), actual.getAllKids());
  ...
  public void testGetImage() {
    ...
    boolean b = actualReturn.equal(actualReturn, expectedReturn);
    if (!b) {
      int i = 4;
    }
    assertEquals("return value", expectedReturn, actualReturn);
