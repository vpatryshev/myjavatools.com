...
//  }
  ...
  public void testReadStringFromFile() {
    ...
    String filename = "src/main/java/com/myjavatools/lib/foundation/Objects.java";
  ...
  public void testReadBytesFromFile() {
    String filename = "src/main/java/com/myjavatools/lib/Files.java";
  ...
  public void testPipe() {
    try {
      InputStream is = new FileInputStream("src/main/java/com/myjavatools/lib/Files.java");
...
/*
  public void testChdirBug() {
      new File("C:/tmp/tmpdir").mkdirs();
      System.setProperty("user.dir", "C:/tmp");
      File subdir = new File("tmpdir");
      assertEquals("C:/tmp/tmpdir", subdir.getAbsolutePath());
...
//  }
  ...
  public void testCopy1() {
    String expectedReturn = "/*\r\n *  <p>Title: My Java Tools Library</p>\r\n *\r\n * <p>Description: This is a mixture of useful Java Tools</p>\r\n";
    copy("src/main/java/com/myjavatools/lib/foundation", "/tmp", "Objects.java");
  ...
  public void testCopy2() {
    String expectedReturn = "/*\r\n *  <p>Title: My Java Tools Library</p>\r\n *\r\n * <p>Description: This is a mixture of useful Java Tools</p>\r\n";
    copy(new File("src/main/java/com/myjavatools/lib/foundation"), new File("/tmp"), "Objects.java");
    String actualReturn = readStringFromFile("/tmp/Objects.java");
    int i = Strings.findDiff(expectedReturn, actualReturn);
    assertEquals(i, expectedReturn.length());
    assertTrue(actualReturn.startsWith(expectedReturn));
  ...
  public void testWriteToFile() {
    try {
      String expectedReturn =
          "/*\r\n *  <p>Title: My Java Tools Library</p>\r\n *";
      String filename1 = "src/main/java/com/myjavatools/lib/foundation/Objects.java";
...
*/
  public void testCopyAndCompare() {
    copy("src/main/java/com/myjavatools/lib", "/tmp/myjavatools/lib");
    String list1 = Strings.join(",", new File("src/main/java/com", "myjavatools/lib").list());
    String list2 = Strings.join(",", new File("/tmp",    "myjavatools/lib").list());
    assertEquals(list1, list2);
  }

  public void testSynchronize() {
    File folder1 = new File("src/main/java/com");
  ...
  public void testFiles() {
    int n = 0;
    for (File f : files(new File("src/main/java/com/myjavatools/lib/human"))) {
      n++;
//      System.out.println(f);
  ...
  public void testTree() {
    ...
    check.add(new File("src/main/java/com/myjavatools"));
    check.add(new File("src/main/java/com/myjavatools/lib"));
    check.add(new File("src/main/java/com/myjavatools/lib/foundation"));
    check.add(new File("src/main/java/com/myjavatools/lib/human"));

    for (File f : tree(new File("src/main/java/com/myjavatools"))) {
//      System.out.println(f);
  ...
  public void testTree1() {
    for (File dir : tree(new File("src/main/java/com/myjavatools"))) {
  ...
  public void testTree2() {
    ...
    for (File f : treePostorder(new File("src/main/java/com/myjavatools"))) {
      System.out.println(f);
      assertTrue("must have contained " + f, check.remove(f));
    }
    assertEquals("must be empty now", check.size(), 0);
