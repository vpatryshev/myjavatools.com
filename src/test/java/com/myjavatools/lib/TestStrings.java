...
//  }
  ...
  public void testJoin() {
    assertEquals("return value", "1, 555", join(", ", new Long[] {valueOf(1), valueOf(555)}));
...
//                     format("{0} + {1} = {2}", new Byte((byte)2), new Byte((byte)2), valueOf(5)));
//  }
...
//    assertEquals("return value", "12 Monkeys", format("{0} Monkeys", valueOf(12)));
//  }
...
*/
  ...
  public void testToString() {
    ...
    String expected2 = "\tat com.myjavatools.lib.TestStrings";
    ...
    try {
      ...
      assertTrue("returnValue is " + returned, returned.startsWith(expected) && returned.contains(expected2));
    }
    assertNull(s);
  }
  ...
  public void testChars1() {
    ...
    for (int i = 0; i < t.length(); i++) {
      assertEquals(Character.valueOf(t.charAt(i)), it.next());
    }
