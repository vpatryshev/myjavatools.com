...
public abstract class Tools
{
  ...
  public static Long[] gc() {
    Long total = valueOf(Runtime.getRuntime().totalMemory() / 1000);
    Long free1 = valueOf(Runtime.getRuntime().freeMemory() / 1000);
    System.gc();
    Long free2  = valueOf(Runtime.getRuntime().freeMemory() / 1000);
