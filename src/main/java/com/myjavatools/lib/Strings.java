...
// html-encode all non-ascii chars
   ...
   *
   * <br><br><b>Examples</b>:<br>
   * <li><code>join(", ", new Long[] {1, 555})</code>
   * returns "1, 555";</li>
   ...
   */
  public static Iterable<CharSequence> split(final CharSequence separator, final CharSequence source) {
   ...
   */
  public static <T extends CharSequence> List<T> grep(T[] source, CharSequence regexp)
 ...
 public static <T extends CharSequence> List<T> grep(T[] source, Pattern regexp) {
   ...
   *
   * <br><br><b>Examples</b>:
   * <li><code>replace("Bokonon loves you", "love", "hate", true)</code>
   * returns "Bokonon hates you";</li>
   ...
   *
   * <br><br><b>Example</b>:
   * <li><code>replace("All I need is love, love, love!", "You")</code>
   * returns "All I need is You, You, You!".</li>
   */
   ...
   *
   * <br><br><b>Example</b>:
   * <li><code>replace("All you need is love, love!", "me")</code>
   * returns "All you need is me, love!".</li>
   */
  public static String replace(CharSequence where,
                               CharSequence oldSubstring,
...
//          Okay, okay, not a hex number...
   ...
   *
   * @see <a href="http://java.sun.com/j2se/5.0/docs/guide/intl/encoding.doc.html">list of Java encodings</a>
   *
   ...
   *
   * <br><br><b>Example</b>:
   * <li><code>Map<String,String> map = new HashMap<String,String>();
   * map.put("PATH", "c:\java\bin");
   * map.put("CLASSPATH", "c:\java\lib");
   * toStrings(map)</code>
   * returns new String[] {"PATH=c:\java\bin", "CLASSPATH=c:\java\lib"}.</li>
   *
   */
  public static <K,V> String[] toStrings(Map<K,V> map) {
   ...
   *
   * <br><br><b>Example</b>:
   * <li><code>toStrings(Arrays.toList(new Object[] { 22, false, "wow"}))</code>
   ...
   *
   * <br><br><b>Example</b>:
   * <li><code>toStrings(Arrays.asList(22, false, "wow"))</code>
   * returns new String[] {"22", "false", "wow"}.</li>
   *
   */
  ...
  public static String[] toStrings(Object object) {
    ...
    if (object instanceof Map) {
      ...
      return toStrings((Object[])object);
    } else {
      return null;
    }
  }
   ...
   *
   * <br><br><b>Examples</b>:
   * <li><code>format("{0} Monkeys", valueOf(12))</code> returns "12 Monkeys".</li>
   * <li><code>format("{0} is {1}", "Life", "struggle")</code> returns "Life is struggle".</li>
   * <li><code>format("{0} + {1} = {2}", new Byte(2), new Byte(2), valueOf(5))</code> returns "2 + 2 = 5".</li>
   *
   */
  public static String format(String fmtString, Object ... parameters)
  {
    return MessageFormat.format(fmtString, parameters);
  }
  ...
  public static Iterable<CharSequence> split(final Pattern pattern,
