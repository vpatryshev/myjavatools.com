...
goog.fx.dom.Scroll = function(element, start, end, time, opt_acc) {
  ...
  var events = [goog.fx.BEGIN, goog.fx.ANIMATE, goog.fx.END];
  goog.events.listen(this, events, this.scrollIt, false, this);
};
...
goog.fx.dom.Resize = function(element, start, end, time, opt_acc) {
  ...
  var events = [goog.fx.BEGIN, goog.fx.ANIMATE, goog.fx.END];
  goog.events.listen(this, events, this.resize_, false, this);
};
 ...
 * @param {Object} e Animation event object
 */
goog.fx.dom.Resize.prototype.resize_ = function(e) {
...
goog.fx.dom.ResizeWidth = function(element, start, end, time, opt_acc) {
  ...
  var events = [goog.fx.BEGIN, goog.fx.ANIMATE, goog.fx.END];
  goog.events.listen(this, events, this.resizeWidth_, false, this);
};
goog.fx.dom.ResizeWidth.inherits(goog.fx.dom.PredefinedEffect);
 ...
 * @param {Object} e Animation event object
 */
goog.fx.dom.ResizeWidth.prototype.resizeWidth_ = function(e) {
  this.element.style.width = Math.round(e.x) + 'px';
};
...
goog.fx.dom.ResizeHeight = function(element, start, end, time, opt_acc) {
  ...
  var events = [goog.fx.BEGIN, goog.fx.ANIMATE, goog.fx.END];
  goog.events.listen(this, events, this.resizeHeight_, false, this);
};
goog.fx.dom.ResizeHeight.inherits(goog.fx.dom.PredefinedEffect);
 ...
 * @param {Object} e Animation event object
 */
goog.fx.dom.ResizeHeight.prototype.resizeHeight_ = function(e) {
  this.element.style.height = Math.round(e.x) + 'px';
};
...
goog.fx.dom.FadeOutAndHide = function(element, time, opt_acc) {
  ...
  goog.events.listen(this, goog.fx.END, this.hide, false, this);
};
