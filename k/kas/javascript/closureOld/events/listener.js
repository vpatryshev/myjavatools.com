 ...
 * @param {Object} var_args The arguments passed
 * @return {Boolean}
 */
goog.events.Listener.prototype.handleEvent = function(var_args) {
  if (this.isFunctionListener_) {
    return this.listener.apply(this.handler || this.src, arguments);
  }
  return this.listener.handleEvent.apply(this.listener, arguments);
};