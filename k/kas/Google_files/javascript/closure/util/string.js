...
goog.string.endsWith = function(str, suffix) {
  ...
  return l >= suffix.length &&
      str.substring(l - suffix.length, l) == suffix;
};
 ...
 * @params {String} str String to be escaped.
 ...
 * @param {String} str
 * @param {Number} Max number of characters
...
goog.string.escapeChar = function(c) {
  var rv = c;
      if (c in goog.string.JS_ESCAPE_MAP_) {
    rv = goog.string.JS_ESCAPE_MAP_[c];
  } else {
